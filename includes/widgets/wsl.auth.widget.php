...
<div class="wp-social-login-widget">
	...
	<!-- 
		! Since WSL 2.1.7, all elements IDs generated by the widget (#wp-social-login-connect-with and #wp-social-login-connect-options) are replaced by css classes.
		! kept for backward compatibility and will be removed.
	-->

	<span id="wp-social-login-connect-with" class="wp-social-login-connect-with"><?php _wsl_e( $wsl_settings_connect_with_label, 'wordpress-social-login'); ?></span>

	<div id="wp-social-login-connect-options" class="wp-social-login-connect-options">
<?php 
...
?>
		...
		<a rel="nofollow" href="<?php echo $authenticate_url; ?>" title="<?php echo sprintf( _wsl__("Connect with %s", 'wordpress-social-login'), $provider_name ) ?>" class="wsl_connect_with_provider" data-provider="<?php echo $provider_id ?>">
			<img alt="<?php echo $provider_name ?>" title="<?php echo sprintf( _wsl__("Connect with %s", 'wordpress-social-login'), $provider_name ) ?>" src="<?php echo $assets_base_url . strtolower( $provider_id ) . '.png' ?>" />
		</a>
