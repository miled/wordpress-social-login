...
<div  id="post-body-content">
	...
	<div id="namediv" class="stuffbox">
		...
		<div class="inside"> 
			...
			<p class="description">
				<?php _wsl_e("<b>Note :</b> Since WSL 2.1.7, all elements IDs generated by the widget are replaced by css classes", 'wordpress-social-login') ?>. 
			</p>
			<table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
			  <tr>  
				<td>
...
&lt;div class=&quot;<code>wp-social-login-widget</code>&quot;&gt;
   ...
   &lt;span class=&quot;<code>wp-social-login-connect-with</code>&quot;&gt;{connect_with_caption}&lt;/span&gt;
