...
<div  id="post-body-content">
	...
	<div id="namediv" class="stuffbox">
		...
		<div class="inside"> 
			<p>
				<?php _wsl_e("To customize the default widget styles you can either: edit the css file <strong>assets/css/style.css</strong>, or change it from this text area", 'wordpress-social-login') ?>. 
				
				<?php _wsl_e('For more information refer to <b><a href="http://hybridauth.sourceforge.net/wsl/customize.html?" target="_blank">WSL User Guide, widget customization</a></b>', 'wordpress-social-login') ?>. 
			</p>
			<p class="description">
				<?php _wsl_e("<b>Note :</b> Since WSL 2.1.7, all elements IDs generated by the widget are replaced by css classes, and class .wsl_connect_with_provider is replaced with .wp-social-login-provider", 'wordpress-social-login') ?>. 
			</p>
			<table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
			  <tr>  
				<td>
...
&lt;div class=&quot;<code>wp-social-login-widget</code>&quot;&gt;
   ...
   &lt;div class=&quot;<code>wp-social-login-connect-options</code>&quot;&gt;
